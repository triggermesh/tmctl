...
func flow(object unstructured.Unstructured) ([]corev1.EnvVar, error) {
	...
	// Flow API group
	case "Transformation":
		var o *flowv1alpha1.Transformation
		if err := runtime.DefaultUnstructuredConverter.FromUnstructured(object.Object, &o); err != nil {
			return nil, err
		}
		return transformation.MakeAppEnv(o), nil
	case "XSLTTransformation":
		var o *flowv1alpha1.XSLTTransformation
		if err := runtime.DefaultUnstructuredConverter.FromUnstructured(object.Object, &o); err != nil {
			return nil, err
		}
	...
	case "XMLToJSONTransformation":
		...
		return xmltojsontransformation.MakeAppEnv(o), nil
	case "JQTransformation":
		var o *flowv1alpha1.JQTransformation
		if err := runtime.DefaultUnstructuredConverter.FromUnstructured(object.Object, &o); err != nil {
			return nil, err
		}
		return jqtransformation.MakeAppEnv(o), nil
	}
